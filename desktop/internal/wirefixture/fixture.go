...
type MethodMetadata struct {
	...
	SaveProjectEnvironmentFile  string `json:"save_project_environment_file"`
...
type Document struct {
	...
	ProjectEnvironment                control.ProjectEnvironment                      `json:"project_environment"`
	SavedProjectEnvironmentFile       control.ProjectEnvironmentFile                  `json:"saved_project_environment_file"`
...
func Fixture() Document {
	...
	return Document{
		Methods: MethodMetadata{
			...
			ProjectEnvironment:          desktopwire.MethodProjectEnvironment,
			SaveProjectEnvironmentFile:  desktopwire.MethodSaveProjectEnvironmentFile,
		...
		Status: control.DaemonStatus{
			...
			Capabilities: []rpc.Capability{
				...
				control.CapabilityProjectEnvironmentV1,
		...
		ProjectEnvironment: control.ProjectEnvironment{
			ProjectID:          "orders-api",
		...
		SavedProjectEnvironmentFile: control.ProjectEnvironmentFile{
			Name:     ".env",
			Contents: "APP_NAME=Orders API\n",
...
func (document Document) Validate() error {
	methods := map[string]string{
		...
		desktopwire.MethodProjectEnvironment:          document.Methods.ProjectEnvironment,
		desktopwire.MethodSaveProjectEnvironmentFile:  document.Methods.SaveProjectEnvironmentFile,
	...
	if err := document.ProjectEnvironment.Validate(); err != nil {
		return fmt.Errorf("validate fixture project environment: %w", err)
	}
	if err := document.SavedProjectEnvironmentFile.Validate(); err != nil {
		return fmt.Errorf("validate fixture saved project environment file: %w", err)
	}
...
func typeScriptType(goType reflect.Type) (string, error) {
	...
	case reflect.TypeFor[control.ProjectEnvironment]():
		return "ProjectEnvironment", nil
	case reflect.TypeFor[control.ProjectEnvironmentFile]():
		return "ProjectEnvironmentFile", nil
