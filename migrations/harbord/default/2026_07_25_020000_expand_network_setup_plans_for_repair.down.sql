-- Down migration (sqlite): restore the bootstrap-only plan shape when no upgraded repair is active.
CREATE TABLE network_setup_plans_bootstrap (
...
INSERT INTO network_setup_plans_bootstrap
...
ALTER TABLE network_setup_plans_bootstrap RENAME TO network_setup_plans;
