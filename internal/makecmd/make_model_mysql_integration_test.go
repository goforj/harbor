...
func TestMakeModelMySQLOneToMany(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLOneToOne(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLMultipleOneToOneSameTable(t *testing.T) {
	db := setupMySQL(t)
	...
	mustExec(t, db, fmt.Sprintf(`CREATE TABLE %s (
		...
		updated_by_user BIGINT UNSIGNED NOT NULL,
		title VARCHAR(255) NOT NULL
	)`, postsTable))
...
func TestMakeModelMySQLSelfReferential(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLManyToMany(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLManyToManyInferredJoinKey(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLPolymorphic(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLPolymorphicMultiType(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLNullableTypes(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLTypeMapping(t *testing.T) {
	db := setupMySQL(t)
	...
	assertFieldTypeContains(t, fields, "Flag", "int")
	assertFieldTypeContains(t, fields, "Note", "string")
}

func TestMakeModelMySQLMissingTableHint(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLUpdateExisting(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLEncryptCompressHooks(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLUpdateRelationships(t *testing.T) {
	db := setupMySQL(t)
...
func TestMakeModelMySQLPackageOutput(t *testing.T) {
	db := setupMySQL(t)
...
func setupMySQL(t *testing.T) *gorm.DB {
	...
	if !isMySQLDriver() {
		t.Skip("mysql driver not configured")
	}
	if !hasMySQLConfig() {
		t.Skip("mysql connection env not configured")
	}
...
func applyIntegrationEnvOverrides() {
	...
	host := str.Of(env.Get("DB_HOST", "")).Trim().String()
	if host == "mysql" && str.Of(env.Get("DB_HOST_IN_DOCKER", "")).Trim().ToLower().String() != "true" {
...
require (
	gorm.io/driver/mysql %s
	gorm.io/gorm %s
)
`, moduleName, versions["gorm.io/driver/mysql"], versions["gorm.io/gorm"])
...
func loadModuleVersions(t *testing.T, root string) map[string]string {
	...
	required := []string{"gorm.io/gorm", "gorm.io/driver/mysql"}
