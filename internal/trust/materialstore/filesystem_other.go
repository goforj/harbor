...
func openPlatformFileNoFollow(string, bool) (*os.File, error) {
	return nil, fmt.Errorf("secure certificate material persistence is unsupported on this platform")
}
...
func platformSameFile(*os.File, *os.File) (bool, error) {
	return false, fmt.Errorf("secure certificate material persistence is unsupported on this platform")
}
