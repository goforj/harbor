...
- Harbor never claims a container unless its Compose project/service/working-directory labels and canonical checkout ownership agree, and its Docker adapter never mutates Engine state.
