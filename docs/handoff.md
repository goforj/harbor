...
- GoForj v0.21.0 exists, but it is not a descendant of `d64c2fe24eb29531177966f9b99841f41193042e` and lacks the managed-session behavior, so development and CI still require that exact pin. Semver-only executable admission remains a known hardening issue.
