...
- GoForj v0.21.0 lacks the managed-session behavior, so development and CI require the reviewed `55a1e57599565c9768627db016fc781e3c705f15` build; broader semver admission remains intentionally disabled.
