...
- The hosted same-port proof now provisions three exact loopback identities, requires three concurrently running generated GoForj Apps on port 3000, and rejects evidence or cleanup that omits any identity; workflow execution remains required native evidence.
