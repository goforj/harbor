...
- GoForj executable admission diagnostics now match the exact policy: a canonical versioned build at or above `v0.20.1-0.20260722020216-d64c2fe24eb2`, or the clean development revision `d64c2fe24eb29531177966f9b99841f41193042e`; no released tag currently contains the combined contract, and newer unversioned development revisions remain rejected.
