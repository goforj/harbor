...
- Vitest coverage for bridge selection, connection epochs, snapshot ordering, status request races, recovery, lookup, failure behavior, wake-driven current-output streaming, compatibility polling, and terminal redraw behavior;
